 ...
 * @author Admin
 */
public class ProcesarClub extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            c.setIdClub(Integer.parseInt(request.getParameter("idClub")));
            ...
            rd=request.getRequestDispatcher("club.jsp");
